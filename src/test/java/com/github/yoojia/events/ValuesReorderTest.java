...
public class ValuesReorderTest {
    ...
    final static Class<?>[] DEFINE = new Class<?>[]{String.class, Integer.class, Integer.class, Double.class, Object.class};

    @Test
    public void testSameOrder(){
        Object[] values = new Object[]{"str", 1, 2, 3.0, 4.0};
        Object[] ordered = MethodHandler.reorderArgs(DEFINE, new PayloadEvent("any", values));
